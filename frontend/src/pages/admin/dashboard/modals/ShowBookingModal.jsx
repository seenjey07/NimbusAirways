...
const ShowBookingModal = ({ bookingData }) => {
  ...
  return (
    <>
      <span className="flex justify-center text-2xl font-bold mb-2">
        Booking Details - ({data.booking?.booking_reference})
      </span>

      {data?.booking && data?.booking?.flight && (
        <div className="justify-center flex border-2 border-black">
          <div>
            <p className="justify-center flex underline underline-offset-1 font-bold ">
              Flight Details
            </p>
            <table>
              <tbody>
                <tr>
                  ...
                  <td className="flex ml-3">
                    {data.booking.flight?.flight_number}
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td className="flex ml-3">
                    {data.route?.origin_location}
                    <span className="italic ml-1 text-sm font-bold">
                      ({data.route?.origin_code})
                    </span>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td className="flex ml-3">
                    {data.route?.destination_location}
                    <span className="italic ml-1 text-sm font-bold">
                      ({data.route?.destination_code})
                    </span>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td className="flex ml-3">
                    {format(
                      data.booking?.flight?.departure_date,
                ...
                <tr>
                  ...
                  <td className="flex ml-3">
                    {format(
                      data.booking.flight?.arrival_date,
                      "MMMM dd, yyyy hh:mm a"
                    )}
                  </td>
                </tr>
            ...
            <table>
              <tbody>
                <tr>
                  ...
                  <td className="flex ml-3">
                    {data.booking.flight.aircraft?.family}
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td className="flex ml-3">
                    {data.booking.flight.aircraft?.model}
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td className="flex ml-3">
                    {data.booking.flight.aircraft?.seat_capacity}
                  </td>
                </tr>
              </tbody>
            </table>
      ...
      <div className="flex-1 justify-center border-2 border-b-black border-x-black p-2 w-full">
        <div className="flex">
          {data.passengers &&
            data.passengers.slice(0, 5).map((passenger, index) => (
              <div
                className=" text-center collapse  bg-white ease-in-out duration-300 focus:bg-slate-200"
                key={passenger.id}
              >
                {" "}
                <input
        ...
        <div className="flex">
          {data.passengers &&
            data.passengers.slice(5, 10).map((passenger, index) => (
              <div
                className=" text-center collapse  bg-white ease-in-out duration-300 focus:bg-slate-200"
                key={passenger.id}
              >
