                  ...
                  >
                    ...
                    <td>
                      ...
                      {aircraft.current_route
                        ? `${aircraft.current_route.id - 1}, ${
                            aircraft.current_route.id
                          }`
                        : "N/A"}
                    </td>
                    <td>
                    ...
                    <td
                      className={`text-center text-xs font-bold rounded-lg hover:bg-slate-200 ${
                        aircraft.status === "inactive"
                          ? "bg-gray-500"
                          : aircraft.status === "on air"
                          ? "bg-green-500"
                          : aircraft.status === "taking off"
                          ? "bg-purple-500"
                          : aircraft.status === "boarding"
                          ? "bg-blue-500"
                    ...
                    <td>
                      <div className="dropdown dropdown-end ">
                        ...
                        <ul
                          tabIndex={0}
                          className="mt-3 z-[1] p-2 shadow menu menu-sm dropdown-content bg-accent text-secondary rounded-box w-52"
                        >
                          <li
                          ...
                          <li
                            className="cursor-pointer"
                            onClick={() =>
                              showAircraftDetailsModal(aircraft.id)
                            }
                          >
                            <a>
                              <AircraftDetailsIcon />
